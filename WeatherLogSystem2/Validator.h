...
public:
    /**
     * @brief Checks if a set of integer is is valid date
     *
    ...
    /**
     * @brief Checks if a set of integer is valid date
     *
     * @param month - The month of the date
     * @param year - The year of the date
     * @return true - Date is valid
    ...
    /**
     * @brief Set if integer is valid month
     *
    ...
    /**
     * @brief Checks if a set of integer is valid 24 hour time
     *
